...
export function SocialMedia() {
    ...
    return (
        <>
            ...
            {showPhoneModal && <Phone onModalClose={() => setShowPhoneModal(false)} data={modal_contents.phone} parent={socialMediasRef} />}
            {showFacbookModal && <Facebook onModalClose={() => setShowFacbookModal(false)} data={modal_contents.facebook} parent={socialMediasRef} />}
            {showTelegramModal && <Telegram onModalClose={() => setShowTelegramModal(false)} data={modal_contents.telegram} parent={socialMediasRef} />}
            {showWatsUpModal && <WatsUp onModalClose={() => setShowWatsUpModal(false)} data={modal_contents.watsup} parent={socialMediasRef} />}
            {showInstagramModal && <Instagram onModalClose={() => setShowInstagramModal(false)} data={modal_contents.instagram} parent={socialMediasRef} />}
            {showViberModal && <Viber onModalClose={() => setShowViberModal(false)} data={modal_contents.viber} parent={socialMediasRef} />}
        </>
    )
}
