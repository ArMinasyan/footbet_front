...
;// CONCATENATED MODULE: ./src/games_data/predictions/slide.js
// icons
...
const slide_data = [{
  ...
  teamOneIcon: atletic/* default.src */.Z.src,
  teamTwoName: 'ПСЖ',
  teamTwoIcon: psj.src,
  prediction: {
    thereIs: false,
