...
__webpack_require__.d(__webpack_exports__, {
  "Te": () => (/* binding */ ADD_FEEDBACK),
  "iL": () => (/* binding */ CHANGE_ACCOUNT_IMAGE),
  "AR": () => (/* binding */ CHANGE_ACCOUNT_INFO),
  "uy": () => (/* binding */ GET_ACCOUNT_INFO),
  "mZ": () => (/* binding */ GET_FEEDBACK),
  "SH": () => (/* binding */ GET_MATCHES_BY_TYPE),
  "Fs": () => (/* binding */ GET_MATCHES_OF_SPECIFIC_DAY),
  "uA": () => (/* binding */ GET_NEWS),
  "s2": () => (/* binding */ GET_PREDICTIONS),
  "Gn": () => (/* binding */ GET_STATISTICS),
  "ym": () => (/* binding */ LOGIN),
  "Nz": () => (/* binding */ REGISTER),
  "MC": () => (/* binding */ SET_NEW_PASSWORD),
  "Cl": () => (/* binding */ START_RESET_PASSWORD),
  "cq": () => (/* binding */ VERIFY_PASSWORD_RESET)
});

// UNUSED EXPORTS: GET_MATCHES, GET_MATCHES_OF_NEXT_DAY
