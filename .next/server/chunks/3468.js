...
var Header_module = __webpack_require__(3404);
...
var Arrow_module = __webpack_require__(3399);
...
var Pagination_module = __webpack_require__(4315);
...
var GameRules_module = __webpack_require__(3503);
...
var PageParticales_module = __webpack_require__(2996);
...
var SlidePages_module = __webpack_require__(1228);
...
var TDMatchesBoard_module = __webpack_require__(2690);
...
var RowTitle_module = __webpack_require__(5557);
...
var RowDescription_module = __webpack_require__(4494);
...
var Row_module = __webpack_require__(5424);
...
var Arrows_Arrow_module = __webpack_require__(7709);
...
var Pagination_Pagination_module = __webpack_require__(2921);
...
function TDMatchesBoard() {
  ...
  (0,external_react_.useEffect)(() => {
    (0,er_lib/* request */.WY)(request_destinations/* GET_MATCHES */.Bd, {}, {
      auth: true
    }).then(matches => {
      const now = Date.now();
...
var TMMatchesBoard_module = __webpack_require__(3234);
...
function TMMatchesBoard() {
  ...
  (0,external_react_.useEffect)(() => {
    (0,er_lib/* request */.WY)(request_destinations/* GET_MATCHES_OF_NEXT_DAY */.vK, {}, {
      auth: true
    }).then(matches => {
      const now = Date.now();
      setMatches(matches.data.data.map(match => {
...
var DayChangeButton_module = __webpack_require__(5110);
...
var TMHeader_module = __webpack_require__(5725);
...
var TodayMatches_module = __webpack_require__(1744);
...
var Matches_module = __webpack_require__(2902);
