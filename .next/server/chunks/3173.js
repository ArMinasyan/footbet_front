...
var Arrow_module = __webpack_require__(3245);
...
function LikeDislikeDrop({
  ...
  return /*#__PURE__*/_jsx("div", {
    ...
    children: /*#__PURE__*/_jsx("div", {
      ...
      children: data.map(el => /*#__PURE__*/_jsxs("div", {
        ...
        children: [/*#__PURE__*/_jsx("img", {
          ...
          className: styles.user_part,
          children: [/*#__PURE__*/_jsx("p", {
            children: el.username
          }), /*#__PURE__*/_jsx("img", {
            src: el.reaction ? likeIcon.src : disLikeIcon.src,
            alt: "reaction"
          })]
        })]
      }))
...
var FeedBack_module = __webpack_require__(3276);
...
/* harmony default export */ const filledStar = ({"src":"/_next/static/image/public/images/main/feedbacks/filledStar.b44aa812dcbf9eb14e64af6c8e7279b3.png","height":26,"width":28,"blurDataURL":"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAHCAYAAAA1WQxeAAAAhUlEQVR42mP4d9qIEYhZGYDg3xljPSA2ZwACoBgbEDMxIAOgQCsQz0EXNADiTCAOAuLb/84YvQHSoUCcAcQWIAVCQDwbiP//O238H2jFHxAbiFcCsRSySX1ASaACsOQyVGtO6DMBBW8A8QogngnEz4AKeeEKgBxtoGAukmmpQGzJwMDAAAAUDl1k5bO5eAAAAABJRU5ErkJggg=="});
;// CONCATENATED MODULE: ./public/images/main/feedbacks/unfilledStar.png
/* harmony default export */ const unfilledStar = ({"src":"/_next/static/image/public/images/main/feedbacks/unfilledStar.26105c5d4e7834de797ed734505ee2bf.png","height":26,"width":28,"blurDataURL":"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAHCAYAAAA1WQxeAAAAfklEQVR42l2NsQqDQBBENyF6TVIGUqZNFxCLEwWxUBHB3kYL8Tc9f2zx2S0uPGZnuJsVDe6mIX4IoyH6s3thlAzuYodggPESuoSw1s3l7AVkusUlWoE/f31gwZSmyeNX9Gvre3jqHjm0u95+wQQtNDDT8LYPfgSz8SM+FRE5AIwvR0qDJC/mAAAAAElFTkSuQmCC"});
...
var LeaveComment_module = __webpack_require__(7080);
...
;// CONCATENATED MODULE: ./components/common/LoadingButton.jsx
...
function LoadingButton(_ref) {
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)("button", _objectSpread(_objectSpread({}, props), {}, {
    type: "submit",
    style: {
      position: 'relative',
    ...
    children: [children, loading ? /*#__PURE__*/jsx_runtime_.jsx("div", {
      style: {
        position: `absolute`,
        top: `15px`,
        left: `80px`
...
function LeaveComment_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function LeaveComment_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { LeaveComment_ownKeys(Object(source), true).forEach(function (key) { LeaveComment_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { LeaveComment_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function LeaveComment_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
function LeaveComment({
  ...
  const commentBoxRef = (0,external_react_.useRef)(null);
  ...
  const submit = async data => {
    ...
    if (matchId) {
      try {
        setLoading(true);
        await (0,er_lib/* request */.WY)(request_destinations/* ADD_FEEDBACK */.Te, {
        ...
        (0,external_react_toastify_.toast)(((_err$response$data = err.response.data) === null || _err$response$data === void 0 ? void 0 : _err$response$data.message) || `Невозможно добавить отзыв`, {
          type: `error`
        });
      } finally {
        setLoading(false);
  ...
  if (!matchId) return /*#__PURE__*/jsx_runtime_.jsx(jsx_runtime_.Fragment, {});
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
    ...
    children: [/*#__PURE__*/jsx_runtime_.jsx("div", {
      ...
      children: [/*#__PURE__*/jsx_runtime_.jsx("div", {
        ...
        children: /*#__PURE__*/jsx_runtime_.jsx("textarea", LeaveComment_objectSpread(LeaveComment_objectSpread({}, register('comment')), {}, {
          id: "comment",
          cols: "30",
          rows: "7",
          ref: commentBoxRef,
        ...
        children: /*#__PURE__*/jsx_runtime_.jsx(LoadingButton, {
          loading: loading,
...
var Pagination_module = __webpack_require__(1660);
...
var Sorting_module = __webpack_require__(1406);
...
var Testimonials_module = __webpack_require__(7862);
