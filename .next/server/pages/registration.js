  ...
  return /*#__PURE__*/jsx_runtime_.jsx("div", {
    ...
    children: /*#__PURE__*/jsx_runtime_.jsx("label", {
      ...
      children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
        ...
        children: [imgInput ? /*#__PURE__*/jsx_runtime_.jsx("img", {
          className: (FileInput_module_default())["image-preview"],
...
function Form({
        ...
        // form configs
  {
    ...
    try {
      ...
      (0,external_react_toastify_.toast)(((_error$response$data = error.response.data) === null || _error$response$data === void 0 ? void 0 : _error$response$data.message) || `Не удалось зарегистрироватся`, {
        type: `error`
      });
    }
  };
