...
;// CONCATENATED MODULE: ./public/images/footer/paypal.png
...
function NewPassword({
  ...
  submit = async data => {
    try {
      ...
      (0,external_react_toastify_.toast)(((_err$response$data = err.response.data) === null || _err$response$data === void 0 ? void 0 : _err$response$data.message) || `unknown error`, {
        type: `error`
      });
    }
  };
...
function LoginForm({
  ...
  submit = async data => {
    try {
      ...
      const user = (_await$request$data = (await (0,er_lib/* request */.WY)(request_destinations/* LOGIN */.ym, data)).data) === null || _await$request$data === void 0 ? void 0 : _await$request$data.data;
      (0,er_lib/* setCookie */.d8)(`access-token`, user.token, 1);
...
function BarItems({
  ...
  return /*#__PURE__*/jsx_runtime_.jsx(jsx_runtime_.Fragment, {
    children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
      ...
      children: [userLogged ? /*#__PURE__*/jsx_runtime_.jsx(Logged, {
        data: user/* user_data */.g
      }) : /*#__PURE__*/jsx_runtime_.jsx("div", {
...
var __webpack_exports__ = __webpack_require__.X(0, [1276,123,4751,9452,5196,7879], function() { return __webpack_exec__(8018); });
